...
public class AddAccountAssignFacilityPageObjects {
	...
	//Add account page, assign facility select all facility name check box
	@FindBy(id="grdAccountList_chkBoxSelectAllACOId")
	public WebElement ChkBoxSelectAllFacilityNameList;
	public void ClickAddAccountSelectAllFacilityNameBox(){
		ChkBoxSelectAllFacilityNameList.click();
	}
	...
	public void ClickAddAccAssignFacilityBtn() {
