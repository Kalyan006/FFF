...
public class AddAccountAssignProviderPageObjects {
	...
	//Add account page, assign provider select all facility last name check box
	@FindBy(id="grdProviderListERX_CBSelectAll")
	public WebElement ChkBoxSelectAllFacilityLastNameList;
	public void ClickAddAccountSelectAllFacilityLastNameBox(){
		ChkBoxSelectAllFacilityLastNameList.click();
	}
