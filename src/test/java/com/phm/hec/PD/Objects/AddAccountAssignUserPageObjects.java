...
public class AddAccountAssignUserPageObjects {
	...
	//Add account page, assign user select all user last name check box
	@FindBy(id="gridCustomUserList_CBSelectAll")
	public WebElement ChkBoxSelectAllUserLastNameList;
	public void ClickAddAccountSelectAllUserLastNameBox(){
		ChkBoxSelectAllUserLastNameList.click();
	}
