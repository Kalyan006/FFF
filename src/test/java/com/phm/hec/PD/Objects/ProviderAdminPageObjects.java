...
public class ProviderAdminPageObjects {
	...
	//click on Audit log sub menu under reports menu
	@FindBy(xpath="//h3[text()='Audit Log']")
	public WebElement lnkAuditreport;
	public void ClickLnkAuditReports()
	{
		lnkAuditreport.click();
	}
